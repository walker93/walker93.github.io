/* [project]/node_modules/@n8n/chat/dist/style.css [client] (css) */
:root {
...
._button_4ilxt_115:active, ._button_4ilxt_115._active_4ilxt_149 {
...
._button_4ilxt_115:active a, ._button_4ilxt_115._active_4ilxt_149 a {
  color: var(--button--color--text--active, var(--button--color--text--primary));
}
...
._button_4ilxt_115._disabled_4ilxt_167, ._button_4ilxt_115._disabled_4ilxt_167:hover, ._button_4ilxt_115._disabled_4ilxt_167:active, ._button_4ilxt_115._disabled_4ilxt_167:focus-visible {
  color: var(--button--color--text--disabled, var(--button--color--text--primary--disabled));
  border-color: var(--button--border-color--disabled, var(--button--border-color--primary--disabled));
  background-color: var(--button--color--background--disabled, var(--button--color--background--primary--disabled));
}

._button_4ilxt_115._disabled_4ilxt_167 a, ._button_4ilxt_115._disabled_4ilxt_167:hover a, ._button_4ilxt_115._disabled_4ilxt_167:active a, ._button_4ilxt_115._disabled_4ilxt_167:focus-visible a {
  color: var(--button--color--text--disabled, var(--button--color--text--primary--disabled));
}

._button_4ilxt_115 ._loading_4ilxt_175, ._button_4ilxt_115 ._loading_4ilxt_175:hover, ._button_4ilxt_115 ._loading_4ilxt_175:active, ._button_4ilxt_115 ._loading_4ilxt_175:focus-visible {
  color: var(--button--color--text--loading, var(--button--color--text--primary));
  border-color: var(--button--border-color--loading, var(--button--border-color--primary));
  background-color: var(--button--color--background--loading, var(--button--color--background--primary));
}

._button_4ilxt_115 ._loading_4ilxt_175 a, ._button_4ilxt_115 ._loading_4ilxt_175:hover a, ._button_4ilxt_115 ._loading_4ilxt_175:active a, ._button_4ilxt_115 ._loading_4ilxt_175:focus-visible a {
  color: var(--button--color--text--loading, var(--button--color--text--primary));
}
...
._disabled_4ilxt_167, ._disabled_4ilxt_167:hover, ._disabled_4ilxt_167:active, ._disabled_4ilxt_167:focus {
  cursor: not-allowed;
...
._withIcon_4ilxt_505, ._icon_4ilxt_511 {
  justify-content: center;
  align-items: center;
  display: inline-flex;
}
...
@container not (min-height: 150px) {
  .empty {
    text-align: left;
    flex-direction: row;
  }
...
/*# sourceMappingURL=node_modules_%40n8n_chat_dist_style_css_65f1660e._.single.css.map*/